<?php
	...
	// \DbmContentTransactionalCommunication\OddCore\Admin\CustomPostTypes\AlreadyRegisteredCustomPostTypePost
	class AlreadyRegisteredCustomPostTypePost {
		...
		function __construct() {
			//echo("\OddCore\Admin\CustomPostTypes\AlreadyRegisteredCustomPostTypePost::__construct<br />");
		...
		public function set_names($system_name) {
			//echo("\OddCore\Admin\CustomPostTypes\AlreadyRegisteredCustomPostTypePost::set_names<br />");
		...
		public function register() {
			//echo("\OddCore\Admin\CustomPostTypes\AlreadyRegisteredCustomPostTypePost::register<br />");
		...
		public function output_after_title() {
			//echo("\OddCore\Admin\CustomPostTypes\AlreadyRegisteredCustomPostTypePost::output_after_title<br />");
		...
		public function output_after_editor() {
			//echo("\OddCore\Admin\CustomPostTypes\AlreadyRegisteredCustomPostTypePost::output_after_editor<br />");
		...
		public function verify_and_save($post_id) {
			//echo("\OddCore\Admin\CustomPostTypes\AlreadyRegisteredCustomPostTypePost::verify_and_save<br />");
		...
		public static function test_import() {
			echo("Imported \OddCore\Admin\CustomPostTypes\AlreadyRegisteredCustomPostTypePost<br />");
		}
	}
?>