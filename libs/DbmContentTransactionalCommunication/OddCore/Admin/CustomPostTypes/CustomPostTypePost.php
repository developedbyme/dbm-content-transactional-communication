<?php
	namespace DbmContentTransactionalCommunication\OddCore\Admin\CustomPostTypes;
	
	// \DbmContentTransactionalCommunication\OddCore\Admin\CustomPostTypes\CustomPostTypePost
	class CustomPostTypePost {
		...
		public function setup_labels_autonaming($name) {
			...
			$this->_labels = array(
				'name' => __( ucfirst($multiple_name), DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
				'singular_name' => __( ucfirst($name), DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
				'menu_name' => __( ucfirst($multiple_name), DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
				'name_admin_bar' => __( ucfirst($name), DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
				'add_new' => __( 'Add New', DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
				'add_new_item' => __( 'Add New '.ucfirst($name), DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
				'edit_item' => __( 'Edit '.ucfirst($name), DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
				'new_item' => __( 'New '.ucfirst($name), DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
				'all_items' => __( 'All '.ucfirst($multiple_name), DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
				'view_item' => __( 'View '.ucfirst($name), DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
				'search_items' => __( 'Search '.ucfirst($multiple_name), DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
				'not_found' => __( 'No '.$multiple_name.' found', DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
				'not_found_in_trash' => __( 'No '.$multiple_name.' found in trash', DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
				'parent_item_colon'     => __( 'Parent '.ucfirst($name).':', DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
				'archives'              => __( ucfirst($name).' Archives', DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
				'edit_item'             => __( 'Edit '.ucfirst($name), DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
				'update_item'           => __( 'Update '.ucfirst($name), DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
				'view_item'             => __( 'View '.ucfirst($name), DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
				'search_items'          => __( 'Search '.ucfirst($multiple_name), DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
				'items_list'            => __( ucfirst($multiple_name).' list', DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
				'items_list_navigation' => __( ucfirst($multiple_name).' list navigation', DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
				'filter_items_list'     => __( 'Filter '.ucfirst($multiple_name).' list', DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN )
			);
			
			//'featured_image'        => __( 'Featured Image', DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
			//'set_featured_image'    => __( 'Set featured image', DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
			//'remove_featured_image' => __( 'Remove featured image', DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
			//'use_featured_image'    => __( 'Use as featured image', DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
			//'insert_into_item'      => __( 'Insert into item', DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
			//'uploaded_to_this_item' => __( 'Uploaded to this item', DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
		}
		...
		public function create_taxonomy($system_name, $display_name, $hierarchical) {
			$new_taxonomy = new \DbmContentTransactionalCommunication\OddCore\Admin\Taxonomies\CustomTaxonomy();
