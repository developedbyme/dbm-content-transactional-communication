<?php
	namespace DbmContentTransactionalCommunication\OddCore\Admin\MetaData;
	
	// \DbmContentTransactionalCommunication\OddCore\Admin\MetaData\PostMetaDataBox
	class PostMetaDataBox {
		...
		function __construct() {
			//echo("\OddCore\Admin\MetaData\PostMetaDataBox::__construct<br />");
		...
		public function create_simple_meta_fields($field_names) {
			foreach($field_names as $field_name) {
				$current_field = new \DbmContentTransactionalCommunication\OddCore\Admin\MetaData\MetaField();
		...
		public function save($post_id) {
			//echo("\OddCore\Admin\MetaData\PostMetaDataBox::save<br />");
		...
		public function verify_and_save($post_id) {
			//echo("\OddCore\Admin\MetaData\PostMetaDataBox::verify_and_save<br />");
		...
		public function output_box_start($post) {
			?>
				<div id="recipe-metadata" class="postbox">
					<h3><span><?php _e($this->_display_name, DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN) ?></span></h3>
					<div class="inside">
			<?php
		}
		
		protected function output_content($post) {
			//echo("\OddCore\Admin\MetaData\PostMetaDataBox::output_content<br />");
		...
		public function output($post) {
			//echo("\OddCore\Admin\MetaData\PostMetaDataBox::output<br />");
		...
		public function output_with_nonce($post) {
			//echo("\OddCore\Admin\MetaData\PostMetaDataBox::output_with_nonce<br />");
		...
		public static function test_import() {
			echo("Imported \OddCore\Admin\MetaData\PostMetaDataBox<br />");
		}
	}
?>