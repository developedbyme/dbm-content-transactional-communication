<?php
	...
	// \DbmContentTransactionalCommunication\OddCore\Admin\MetaData\PostMetaDataBoxRegistration
	class PostMetaDataBoxRegistration {
		...
		public function register() {
			...
			add_meta_box( 
				$this->_system_name, 
				__($this->_box->get_name(), DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN), 
