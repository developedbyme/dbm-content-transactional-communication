<?php
	...
	use \DbmContentTransactionalCommunication\OddCore\Admin\MetaData\PostMetaDataBox;
	
	// \DbmContentTransactionalCommunication\OddCore\Admin\MetaData\ReactPostMetaDataBox
	class ReactPostMetaDataBox extends PostMetaDataBox {
		...
		function __construct() {
			//echo("\OddCore\Admin\MetaData\ReactPostMetaDataBox::__construct<br />");
			...
			//$portrait_image_meta_field = new \DbmContentTransactionalCommunication\OddCore\Admin\MetaData\MetaField();
		...
		protected function output_content($post) {
			//echo("\OddCore\Admin\MetaData\ReactPostMetaDataBox::output_content<br />");
		...
		public static function test_import() {
			echo("Imported \OddCore\Admin\MetaData\ReactPostMetaDataBox<br />");
		}
	}
?>