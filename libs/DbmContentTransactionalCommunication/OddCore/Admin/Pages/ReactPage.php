<?php
	namespace DbmContentTransactionalCommunication\OddCore\Admin\Pages;
	
	use DbmContentTransactionalCommunication\OddCore\Admin\Pages\Page as Page;
	
	// \DbmContentTransactionalCommunication\OddCore\Admin\Pages\ReactPage
