<?php
	namespace DbmContentTransactionalCommunication\OddCore\Admin\Taxonomies;
	
	// \DbmContentTransactionalCommunication\OddCore\Admin\Taxonomies\CustomTaxonomy
	class CustomTaxonomy {
		...
		public function setup_labels_autonaming($name) {
			...
			$this->_labels = array(
				...
				'not_found' => __( 'No '.$name.' found', DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
				'not_found_in_trash' => __( 'No '.$name.' found in trash', DBM_CONTENT_TRANSACTIONAL_COMMUNICATION_TEXTDOMAIN ),
				'parent_item_colon' => '',
