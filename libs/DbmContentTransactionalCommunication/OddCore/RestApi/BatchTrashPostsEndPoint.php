<?php
	...
	// \DbmContentTransactionalCommunication\OddCore\RestApi\BatchTrashPostsEndPoint
	class BatchTrashPostsEndPoint extends EndPoint {
		...
		public function perform_call($data) {
			...
			remove_action( 'transition_post_status',           array( '\DbmContentTransactionalCommunication\Helper\Headlines', 'transition_post_status' ), 10, 3 );
			remove_action( 'transition_post_status',           array( '\DbmContentTransactionalCommunication\Helper\PartnerPromotion', 'transition_post_status' ), 10, 3 );
