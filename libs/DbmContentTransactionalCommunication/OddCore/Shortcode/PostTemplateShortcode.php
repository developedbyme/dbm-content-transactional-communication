<?php
	namespace DbmContentTransactionalCommunication\OddCore\Shortcode;
	
	use \DbmContentTransactionalCommunication\OddCore\Shortcode\ShortcodeFilter;
	
	// \DbmContentTransactionalCommunication\OddCore\Shortcode\PostTemplateShortcode
